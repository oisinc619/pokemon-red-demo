...
public class PlayerGridMove : MonoBehaviour
{
    ...
    private void CheckForAreaTransitions()
    {
        ...
        {
            // Query the targeted trigger object to verify it possesses your map-loading script component
            if (triggerCheck.TryGetComponent<AreaMove>(out var areaTransition))
            {
                ...
                // Ready for next steps: we will call your explicit scene-changing methods here!
            }
        }
    }
